...
let cards = {
    icyfreeze: {
        ...
        text: (state, index, array) => { 
          return `Gain ${array[index].baseBlock + state.playerMonster.dex + (10*array[index].upgrades)} block. All enemies lose ${array[index].energyDrain + Math.floor(array[index].upgrades/2)} energy` 
        },
      ...
      dampen: {
        ...
        name: "Dampen",
        text: (state, index, array) => {
                return `All enemies lose ${array[index].energyDestroy + Math.floor(array[index].upgrades)} energy` 
        },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
      ...
      sanguineshield: {
        ...
        text: (state, index, array) => { return `Enemy gains ${array[index].energyGift} energy. Gain ${array[index].baseBlock + (array[index].upgrades*5)} block` },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
        upgrades: 0,
      ...
      shatteringshield: {
        ...
        text: (state, index, array) => { return `Enemy loses ${array[index].energyDestroy} energy. Gain ${array[index].baseBlock + (array[index].upgrades*5)} block` },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
        upgrades: 0,
      ...
      peacefulmind: {
        ...
        name: "Peaceful Mind",
        text: (state, index, array) => { 
          return `Gain ${array[index].baseBlock + state.playerMonster.dex + (5*array[index].upgrades)} block. Gain 5 dexterity` 
        },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
      ...
      essencedrain: {
        ...
        name: "Essence Drain",
        cardType: "fire",
        text: (state, index, array) => { return `Enemy loses ${array[index].energyDrain} energy. Gain ${array[index].baseBlock + state.playerMonster.dex + (array[index].upgrades*5)} block` },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
        baseCost: 1,
      ...
      decimate: {
        ...
        text: (state, index, array) => { 
          if (array[index].baseHits === 1) {
            return `Deal ${array[index].baseDamage + (array[index].upgrades*10) + state.playerMonster.strength} damage. Enemy loses ${array[index].energyDrain + array[index].upgrades} energy`;
          } else { 
            return `Deal ${array[index].baseDamage + (array[index].upgrades*10) + state.playerMonster.strength} damage ${array[index].baseHits} times. Enemy loses ${array[index].energyDrain + array[index].upgrades} energy`
          }
      },
      minReq: (state, index, array) => {
        return array[index].baseCost;
      ...
      sabotage: {
        name: "Sabotage",
        text: (state, index, array) => {
          return `Gain ${array[index].baseBlock + state.playerMonster.dex + (array[index].upgrades*5)} block. Enemy loses ${array[index].energyDrain+Math.floor(array[index].upgrades/2)} energy`
        },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
      ...
      thiefshield: {
        ...
        cardID: 39,
        name: "Thief's Shield",
        text: (state, index, array) => { return `Enemy loses ${array[index].energyDrain + Math.floor(array[index].upgrades/2)} energy. Gain ${array[index].baseBlock + (array[index].upgrades*5)} block for each energy drained.` },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
        upgrades: 0,
      ...
      puffofsmoke: {
        ...
        text: (state, index, array) => { 
          ...
          if (state.status === Status.ChooseEncounterCardReward || state.status === Status.cardShop) {
            textString += "<br></br><br> (Backstep cards cost 0, gain 5 block, and are removed from your deck when played)</br>"
          }
          return textString
        },
        minReq: (state, index, array) => {
      ...
      skipaway: {
        ...
        name: "Skip Away",
        text: (state, index, array) => { 
          let textString = `Gain ${(3+array[index].upgrades)} Backstep cards`;
          if (state.status === Status.ChooseEncounterCardReward || state.status === Status.cardShop) {
            textString += "<br></br><br> (Backstep cards cost 0, gain 5 block, and are removed from your deck when played)</br>"
          }
          return textString
      ...
      powerup: {
        ...
        text: (state, index, array) => {
            if (array[index].upgrades < array[index].baseCost) {
                ...
                return `Double your energy. Gain ${(array[index].baseBlock * array[index].upgrades*5) + state.playerMonster.dex} block. Remove`
            }
        },
      ...
      disablingblow: {
        ...
        text: (state, index, array) => { 
          if (array[index].baseHits === 1) {
            return `Deal ${array[index].baseDamage + (array[index].upgrades*2) + state.playerMonster.strength} damage. Opponent loses ${5} strength`;
          } else {
            return `Deal ${array[index].baseDamage + array[index].upgrades + state.playerMonster.strength} damage ${array[index].baseHits} times. Opponent loses ${5} strength`
          }
      },
      minReq: (state, index, array) => {
        return array[index].baseCost;
      ...
      throwsand: {
        ...
        name: "Throw Sand",
        text: (stateObj, index, array) => { 
          let textString = `Enemy loses ${5} strength. Gain ${(3+array[index].upgrades)} Backstep card`;
          if (array[index].upgrades > 0) {
            textString += `s`;
          } 
          if (state.status === Status.ChooseEncounterCardReward || state.status === Status.cardShop) {
      ...
      precisionstrike: {
        ...
        text: (state, index, array) => { 
          if (array[index].baseHits === 1) {
            return `Deal ${array[index].baseDamage + (5*array[index].upgrades) + state.playerMonster.strength} damage. Gain ${5} dexterity`;
          } else {
            return `Deal ${array[index].baseDamage + (5*array[index].upgrades) + state.playerMonster.strength} damage ${array[index].baseHits} times. Gain ${5} dexterity`
          }
      },
      minReq: (state, index, array) => {
        return array[index].baseCost;
      ...
      meditate: {
        ...
        text: (state, index, array) => { 
            if (array[index].upgrades ===0) {
                return `Gain ${array[index].baseBlock + state.playerMonster.dex + (array[index].upgrades*5)} block. Return the last card played to your hand`
            } else {
                return `Gain ${array[index].baseBlock + state.playerMonster.dex + (array[index].upgrades*5)} block. Return the last ${1+array[index].upgrades} cards played to your hand`
            }
          },
        minReq: (state, index, array) => {
          return array[index].baseCost;
      ...
      dancersgrace: {
        ...
        text: (state, index, array) => { 
          if (array[index].upgrades === 0) {
            return `Gain 5 Dexterity. Gain ${array[index].baseBlock} block. Remove`;
          } else {
            return `Gain ${5} Dexterity. Gain ${array[index].baseBlock + (5*array[index].upgrades)} block.`;
          }
        },
    ...
    ignite: {
        cardID: 65,
        name: "Ignite",
        text: (state, index, array) => { return `Enemy gains ${array[index].energyGift} energy. Attacks deal +${5 + (array[index].upgrades*5)} damage this turn.` },
        minReq: -99,
        baseCost: 0,
        cost:  (state, index, array) => {
          return array[index].baseCost;
      ...
      annihilation: {
        ...
        text: (state, index, array) => {
          if (array[index].baseHits===1) {
            return `Gain ${array[index].baseBlock + (array[index].upgrades*10) + state.playerMonster.dex} block. Deal ${array[index].baseDamage + (array[index].upgrades*5) + state.playerMonster.strength} damage`;
          } else {
            return `Gain ${array[index].baseBlock + (array[index].upgrades*10) + state.playerMonster.dex} block. Deal ${array[index].baseDamage + (array[index].upgrades*5) + state.playerMonster.strength} damage ${array[index].baseHits} times`;
          }
      ...
      microFlames: {
        cardID: 66,
        name: "Micro Flames",
        text: (state, index, array) => { return `Destroy 2 energy. Your attacks do +${(5 + (2*array[index].upgrades))} damage this turn`},
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
        baseCost: 1,
      ...
      reformingshield: {
        ...
        text: (state, index, array) => { 
          return `Gain ${array[index].baseBlock + (5*array[index].upgrades)} block at the end of each turn. Remove`;
        },
        minReq: (stateObj, index, array) => {
          return array[index].baseCost;
        },
      ...
      flamedome: {
        ...
        text: (state, index, array) => {
          if (array[index].baseHits===1) {
            return `Gain ${array[index].baseBlock + (array[index].upgrades*5) + state.playerMonster.dex} block. Deal ${array[index].baseDamage + (array[index].upgrades*5) + state.playerMonster.strength} damage to all enemies`;
          } else {
            return `Gain ${array[index].baseBlock + (array[index].upgrades*5) + state.playerMonster.dex} block. Deal ${array[index].baseDamage + (array[index].upgrades*5) + state.playerMonster.strength} damage to all enemies ${array[index].baseHits} times`;
          }
      ...
      unwaveringdefense: {
        ...
        text: (state, index, array) => { 
          return `Gain ${array[index].baseBlock + state.playerMonster.dex + (10*array[index].upgrades)} block. Your block does not disappear at end of turn.` 
        },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
      ...
      whirlwind: {
        ...
        name: "Shield Spikes",
        text: (state, index, array) => { 
          return `Backsteps also damage enemies. Remove` 
        },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
      ...
      expand: {
        ...
        name: "Expand",
        text: (state, index, array) => { 
          return `Gain ${5 + (5*array[index].upgrades)} strength whenever you make opponent gain or lose energy. Remove` 
        },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
    ...
    endingfeint: {
      ...
      text: (state, index, array) => {
          ...
          textString += `Add ${2 + array[index].upgrades} Backsteps to your hand`
           return textString;
      },
      minReq: (state, index, array) => {
        return array[index].baseCost;
      ...
      fierymissiles: {
        cardID: 21,
        name: "Fiery Missiles",
        text: (state, index, array) => { return `Enemy gains ${array[index].energyGift} energy. Deal ${(array[index].baseDamage + state.playerMonster.strength + (5* array[index].upgrades))} damage ${(array[index].baseHits)} times` },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
        baseCost: 2,
      ...
      flamewhip: {
        ...
        text: (state, index, array) => { 
          if (array[index].baseHits === 1) {
            return `Enemy gains ${array[index].energyGift} energy. Deal ${(array[index].baseDamage + state.playerMonster.strength + (array[index].upgrades*5))} damage to all enemies` 
          } else {
            return `Enemy gains ${array[index].energyGift} energy. Deal ${(array[index].baseDamage + state.playerMonster.strength + (array[index].upgrades*5))} damage to all enemies ${(array[index].baseHits)} times` 
          }
        },
        minReq: (state, index, array) => {
          return array[index].baseCost;
      ...
      flamingcloak: {
        ...
        name: "Flaming Cloak",
        text: (state, index, array) => {
            return `Gain ${array[index].baseBlock + (array[index].upgrades*5) + state.playerMonster.dex} block. Attacks deal +${(1+array[index].upgrades) * 5} damage this turn`
        },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
      ...
      rareupgrade: {
        ...
        name: "Bide",
        text: (state, index, array) => { 
          let textString = `Gain ${array[index].baseBlock + state.playerMonster.dex + (array[index].upgrades*5)} block. Upgrade your top left card`
      ...
      fortify: {
        ...
        text: (stateObj, index, array) => {
          ...
          if (stateObj.playerMonster.encounterBlock >= 5) {
            ...
            return `Gain ${cardBlock} block. Gain ${cardBlock} more if you already have at least 10 block`
          }
        },
        minReq: (stateObj, index, array) => {
          return array[index].baseCost;
      ...
      invigorate: {
        cardID: 31,
        name: "Invigorate",
        text: (state, index, array) => { return `Gain ${array[index].baseBlock + state.playerMonster.dex + (array[index].upgrades*5)} block. Gain 5 strength.`},
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
        baseCost: 2,
      ...
      infuse: {
        cardID: 32,
        name: "Infuse",
        text: (state, index, array) => { return `Gain ${array[index].baseBlock + state.playerMonster.dex + (array[index].upgrades*5)} block. Upgrade your top left card twice.`},
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
        baseCost: 2,
      ...
      forgeshield: {
        ...
        text: (state, index, array) => {
          ...
          if (state.status === Status.InEncounter) {
            ...
            return `Gain ${blockTotal} block. Gain 5 extra block for each upgrade you have (${totalEncounterUpgrades+blockTotal} total)`;
          } else {
      ...
      siphon: {
        cardID: 33,
        name: "Siphon",
        text: (state, index, array) => { return `Enemy loses ${array[index].energyDrain + array[index].upgrades} energy. Upgrade your top left card twice`},
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
        baseCost: 1,
      ...
      cursedritual: {
        ...
        cardID: "strength1",
        text: (state, index, array) => { 
          return `Enemy gains ${array[index].energyGift} energy. Gain ${5 + (5*array[index].upgrades)} strength` 
        },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
      ...
      ritual: {
        ...
        exhaust: true,
        text: (state, index, array) => { 
          return `Gain ${10 + (array[index].upgrades)} strength. Remove` 
        },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
      ...
      brandingiron: {
        ...
        text: (stateObj, index, array) => { 
          ...
          return `Deal ${selfDamage + array[index].upgrades} damage to yourself. Gain ${10+ (5*array[index].upgrades)} strength`; 
        },
        minReq: 0,
        upgrades: 0,
        baseCost: 1,
      ...
      flagellate: {
        ...
        text: (stateObj, index, array) => {
          selfDamage = (stateObj.cantSelfDamage === true) ? 0  : array[index].baseSelfDamage; 
          return `Deal ${selfDamage + array[index].upgrades} damage to yourself. Gain ${5+(5*array[index].upgrades)} strength`;
          },
        minReq: 0,
        upgrades: 0,
        baseCost: 0,
      ...
      enlightened: {
        cardID: "noselfdamage",
        name: "Enlightened",
        text: (state, index, array) => { return `Gain ${array[index].baseBlock + (5*array[index].upgrades)} block. You can't damage yourself.` },
        minReq: 0,
        upgrades: 0,
        baseCost: 1,
        cost:  (state, index, array) => {
      ...
      gainstrength: {
        ...
        name: "Bulk Up",
        text: (state, index, array) => {
          return `Gain 5 Strength permanently. Remove`;
        },
        minReq: (state, index, array) => {
          return (array[index].baseCost - (array[index].upgrades))
        },
      ...
      gainstrengthtemp: {
        ...
        name: "Leg Day",
        text: (state, index, array) => {
          return `Gain 5 Strength permanently. Purge`;
        },
        minReq: (state, index, array) => {
          return (array[index].baseCost - (array[index].upgrades))
        },
      ...
      gaindextemp: {
        ...
        name: "Footwork",
        text: (state, index, array) => {
          return `Gain 5 Dexterity permanently. Purge`;
        },
        minReq: (state, index, array) => {
          return (array[index].baseCost - (array[index].upgrades))
        },
      ...
      hypertrain: {
        ...
        text: (state, index, array) => {
          ...
          if (array[index].upgrades > 0) {
            textString += `. Gain ${array[index].upgrades*5} Strength`
          }
          return textString
        },
        action: async (stateObj, index, array) => {
...
// Poison Cards 
      ...
      venomshield: {
        name: "Venom Shield",
        text: (state, index, array) => {
          return `Gain ${array[index].baseBlock + (array[index].upgrades*5) + state.playerMonster.dex} block. Apply ${array[index].basePoison} poison to all enemies`
        },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
      ...
      poisondrain: {
        name: "Poison Drain",
        text: (state, index, array) => { return `Apply ${array[index].basePoison + (5*array[index].upgrades)} poison. Enemy loses ${array[index].destroyEnergy} energy` },
        minReq: (state, index, array) => {
          return array[index].baseCost;
        },
        cost:  (state, index, array) => {
      ...
      cloakingfog: {
        name: "CloakingFog",
        text: (state, index, array) => { return `Gain ${array[index].baseBlock + state.playerMonster.dex} block. Gain ${4+array[index].upgrades} Backsteps` },
        minReq: 2,
        upgrades: 0,
        baseCost: 2,
        baseBlock: 5,
